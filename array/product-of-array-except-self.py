...
class Solution:
    ...
    # Ý tưởng sẽ là dùng prefix và postfix
    # [1, 2, 3, 4] nếu muốn tính của nums[2] -> nums[2] = (nums[0] * nums[1]) * nums[3]
    def productExceptSelf(self, nums: List[int]) -> List[int]:
        ans = [1] * len(nums)
        
        # Giá trị của phần tử đầu tiên (prefix) và cuối cùng (postfix) phải luôn là 1
        prefix = 1
